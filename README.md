...
### Flask 
We also create our app   by using flask , then deployed it to Heroku. You can access the app by following this link : https://spotify-skip-pred-flask.herokuapp.com/
